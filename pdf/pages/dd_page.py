...
class DDPage(VirtualPage):
    ...
    def __init__(self, driver, url):
        ...
        self.add_element("VH3FamilyIdSelectData", "(//div[contains(@class,'sankey-chart')]//*[contains(@class, 'fa-cog')])[1]")
        self.add_element("VH3PotentialTargetSelectData", "(//div[contains(@class,'sankey-chart')]//*[contains(@class, 'fa-cog')])[2]")
        ...
        self.add_element("1stElementInSelectData", "(//*[contains(@class, 'checkbox__list') or contains(@class, 'select-body')]//label//*[contains(@class, 'rank')])[1]")
        self.add_element("2ndElementInSelectData", "(//*[contains(@class, 'checkbox__list') or contains(@class, 'select-body')]//label//*[contains(@class, 'rank')])[2]")
        self.add_element("3rdElementInSelectData", "(//*[contains(@class, 'checkbox__list') or contains(@class, 'select-body')]//label//*[contains(@class, 'rank')])[3]")
        self.add_element("4thElementInSelectData", "(//*[contains(@class, 'checkbox__list') or contains(@class, 'select-body')]//label//*[contains(@class, 'rank')])[4]")
        self.add_element("5thElementInSelectData", "(//*[contains(@class, 'checkbox__list') or contains(@class, 'select-body')]//label//*[contains(@class, 'rank')])[5]")
        self.add_element("6thElementInSelectData", "(//*[contains(@class, 'checkbox__list') or contains(@class, 'select-body')]//label//*[contains(@class, 'rank')])[6]")
        self.add_element("7thElementInSelectData", "(//*[contains(@class, 'checkbox__list') or contains(@class, 'select-body')]//label//*[contains(@class, 'rank')])[7]")
        self.add_element("8thElementInSelectData", "(//*[contains(@class, 'checkbox__list') or contains(@class, 'select-body')]//label//*[contains(@class, 'rank')])[8]")
        self.add_element("9thElementInSelectData", "(//*[contains(@class, 'checkbox__list') or contains(@class, 'select-body')]//label//*[contains(@class, 'rank')])[9]")
        self.add_element("10thElementInSelectData", "(//*[contains(@class, 'checkbox__list') or contains(@class, 'select-body')]//label//*[contains(@class, 'rank')])[10]")
    ...
    def change_tech1_select_data(self):
        ...
        self.op.click(self.get_element("6thElementInSelectData"))
        self.op.click(self.get_element("7thElementInSelectData"))
        self.op.click(self.get_element("8thElementInSelectData"))
    ...
    def change_tech2_class_select_data(self):
        ...
        self.op.click(self.get_element("7thElementInSelectData"))
        self.op.click(self.get_element("8thElementInSelectData"))
        self.op.click(self.get_element("9thElementInSelectData"))
        self.op.click(self.get_element("10thElementInSelectData"))
        self.op.click(self.get_element("SelectDataSubmit"))
        self.op.sleep(2)
        self.wait_for_tech2()
