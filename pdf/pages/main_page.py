...
class MainPage(VirtualPage):
    ...
    def __init__(self, driver, url):
        ...
        self.add_element("LoginEmail", "//input[@id='signName']")
        self.add_element("LoginPassword", "//input[@id='signPass']")
        self.add_element("LoginSubmit", "//*[contains(@class, 'modal-body') or contains(@class, 'login-box')]//*[@i18n-txt='system.login']")
